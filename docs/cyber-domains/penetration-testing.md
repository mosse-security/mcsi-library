...
<img alt="penetration testing procedure and workflow" src="/images/procedures/penetration-testing.svg">

The image above proposes a workflow you can use to learn penetration testing.
