...
```{admonition} What is Open Source Intelligence (OSINT)?
:class: dropdown
...
- [Collecting open source data from Twitter](https://youtu.be/-bQE2sY86S0)
...
```{image} /images/certifications/mois-certified-osint-expert.png
:class: grey-border width-100-per
:target: https://www.mosse-institute.com/certifications/mois-certified-osint-expert.html
```